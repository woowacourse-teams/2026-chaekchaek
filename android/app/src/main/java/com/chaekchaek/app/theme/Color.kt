...
val ChaekDarkBackground = Color(0xFF1A1A1A)
val ChaekDarkSurface = Color(0xFF242424)
val ChaekDarkSurfaceMuted = Color(0xFF302C27)
val ChaekDarkInk = Color(0xFFFCFAF7)
val ChaekDarkInkSecondary = Color(0xFFC9C3BA)
val ChaekDarkBorder = Color(0xFF4A4743)
val ChaekDarkAccent = Color(0xFFFFB74D)
